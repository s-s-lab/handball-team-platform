  ...
  it("builds the dashboard overview from match and roster data", async () => {
    ...
    const summary = dashboard.buildDashboardSummary({
      ...
      matches: [
        ...
        {
          id: "finished-old",
          name: "Cup quarterfinal",
          opponentName: "Saitama HC",
          teamSide: "home",
    ...
    expect(summary.topScorers.map((player: { teamMemberId: string | null }) => player.teamMemberId)).toEqual([
      "p2",
      "p1",
      "p3",
    ]);
